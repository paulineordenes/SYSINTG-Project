...
<html>
	...
	<body>
		...
		<div class="list">
			<p><a href="sortLastNameD.php"><input type="button" value="Order: Z->A"></a></p>
			...
			<table align="center">
				...
				<?php
					require_once('mysql_connect.php');
					$query="select data.lastname, data.name, data.birthday, data.university from students.data ORDER BY lastname ASC;";
					$result=mysqli_query($dbc,$query);
